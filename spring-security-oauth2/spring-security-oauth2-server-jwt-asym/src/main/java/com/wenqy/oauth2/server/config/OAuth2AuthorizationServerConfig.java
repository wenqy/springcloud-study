...
public class OAuth2AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public JwtAccessTokenConverter accessTokenConverter() {
        ...
        converter.setKeyPair(keyStoreKeyFactory.getKeyPair("mytest")); // rsa 非对称密钥
        return converter;
    }
...
//                .authorizedGrantTypes("password", "authorization_code", "refresh_token")
                ...
                .scopes("all")
                .redirectUris("http://localhost:58093/oauth2-resource/login")
                .autoApprove(false)
                .and()
                .withClient("sheep2")
                .secret(new BCryptPasswordEncoder().encode("123456"))
                ...
                .scopes("all")
                .autoApprove(false)
                .redirectUris("http://localhost:58094/login/oauth2/code/login-client");
    } // @formatter:on
}